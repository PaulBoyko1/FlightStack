...
def simulate_attitude_step(plant: RigidBody, controller: AttitudeController, target_q: ArrayLike, *, duration_s: float = 4.0, dt: float = 0.002) -> Telemetry:
    ...
    for index in range(1, steps + 1):
        desired, terms = controller.update(plant.state.attitude, target, plant.state.body_rate, dt)
